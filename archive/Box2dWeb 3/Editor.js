Editor = function(game){
    ...
    this.activeMaterial = "platform"
    this.setListeners()
}
Editor.prototype.setListeners = function() {
    var self = this
    $("#materials a").on("click", function(e){
        e.preventDefault()
        self.activeMaterial = $(this).attr("href").substr(1)
...
Crosshair.prototype.draw = function() {
    ...
    this.ctx.strokeRect(this.x1 * tileSize, this.y1 * tileSize, (this.x2 - this.x1) * tileSize, (this.y2 - this.y1) * tileSize);
